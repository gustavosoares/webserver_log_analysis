...
class TestParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_line_3 = line = 'localhost 2015-10-18 23:59:53 LOCAL6 NOTICE nginx 18/Oct/2015:23:59:53 -0200        127.0.0.1   example.com   POST      //abc//123/127.0.0.1/123/4       -       -  -       Local:  400     0       0.000   *383423 Proxy:  -       -       -       -       -       Agent:  -       Fwd:    -'
        self.sample_line_4 = line = 'localhost 2015-10-18 23:59:53 LOCAL6 NOTICE nginx 18/Oct/2015:23:59:53 -0200        127.0.0.1   example.com   POST      //abc//123/127.0.0.1/123//vm-1cdbe056-ac8f-47d1-9288-9a21f80345df/       -       -  -       Local:  400     0       0.000   *383423 Proxy:  -       -       -       -       -       Agent:  -       Fwd:    -'
    ...
    def test_filter_ip(self):
        ...
        self.assertEqual('18/Oct/2015:23:59:53 POST /abc/#/#/#/# 400 0.000', self.lognit_parser.parse_line(self.sample_line_3))

    def test_filter_uuid(self):

        self.assertEqual('18/Oct/2015:23:59:53 POST /abc/#/#/#/vm-UUID/ 400 0.000', self.lognit_parser.parse_line(self.sample_line_4))
